...
def add_to_manifest(repos, fallback_branch=None):
    ...
    yukim = load_manifest(yuki_manifest)
    ...
    for repo in repos:
        ...
        elif exists_in_tree(yukim, repo_target) != None:
            existing_m_project = exists_in_tree(yukim, repo_target)
